...
const User = ({ match }) => {
  ...
  const getWallet = async (id) => {
    const res = await axios.get(`${CONSTANT.baseUrl}/api/user/wallet?_id=${id}`);
                          ...
                          <div class="col-sm-6">
                            <ul>
                              ...
                              <li>
                                ...
                                <span class="Discribe">{wallet.referral_ammount} INR</span>
                              </li>
                              <li>
                                <span class="Title">Mining Ammount </span>
                                <span class="Discribe">{wallet.mining_ammount} INR</span>
                              </li>
                            </ul>
                          </div>
                          <div class="col-sm-6">
                            <ul>
                              ...
                              <li>
                                ...
                                <span class="Discribe">{wallet.earning_ammount} INR</span>
                              </li>
                              <li>
                                <span class="Title">Total Amount</span>
                                <span class="Discribe">{wallet.total_amount} INR</span>
                              </li>
                            </ul>
                          </div>
                        </div>
